 ...
 *
 * Declared identically in targets/today-widget so both sides encode the same
 * thing; ActivityKit matches activities by this type, and the app and the
 * extension are separate binaries that cannot share one file here. Keep the
 * two copies in step.
 */
